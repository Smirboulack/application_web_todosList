<%@ page contentType="text/html;charset=UTF-8" %>
    ...
    <body>
        <header>
            ...
            <p class="header-user">Bonjour <strong><a href="User?user=${sessionScope.login}"
                        target="list">${applicationScope.users.findOne(sessionScope.login).name}</a></strong></p>
        ...
        <div class="wrapper">
            <aside class="menu">
                <h2>Menu</h2>
                <div>
                    <a href="UserList" target="list">Utilisateurs</a>
                </div>
                <div>
                    <a href="todolist" target="list">Tâches</a>
                </div>
                <div>
                    <a href="connect">D&eacute;connexion</a>
                </div>
            </aside>
