 ...
 * N'autorise l'accès qu'aux clients ayant déjà une session existante ou ayant
 * rempli le formulaire de la page <code>index.html</code>.
 * Dans ce dernier cas, le filtre crée la session de l'utilisateur, crée un
 * objet User et l'ajoute en attribut de la session.
...
public class Auth extends HttpFilter {
    ...
    protected void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        // Note :
        // le paramètre false dans request.getSession(false) permet de récupérer null si
        // la session n'est pas déjà créée.
        // Sinon, l'appel de la méthode getSession() la crée automatiquement.
        if (url.equals("/") || url.equals("/css/style.css") || url.equals("/index.html")
        ...
        // Traite les formulaires de modifications
